...
describe('array methods', () => {
    ...
    describe('index as second argument to callback', () => {

        const recordIndex = returnValue => indexes => (each, i) => {
            indexes[i] = i;
            return returnValue;
        };
        ...
        function testIndexes(name, fn, makeCallback = recordIndexReturnTrue) {
            it(name, () => {
                ...
                // pass third arg for reduce so it thinks it needs an accumulator
